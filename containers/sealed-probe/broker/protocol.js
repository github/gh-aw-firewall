...
/**
 * Sealed-probe request/result protocol v2 — broker-side implementation.
 *
...
const PROBE_PROTOCOL_VERSION = 2;
...
function validateSealedProbeRequest(raw) {
  if (typeof raw !== 'object' || raw === null || Array.isArray(raw)) {
...
function parseAndValidateProbeOutput(raw, schema) {
