 ...
 * budgets — broker-side mirror of `SEALED_PROBE_SENSITIVITY_RUN_BITS` in
 * `src/types/sealed-probe-options.ts`. Kept in a tiny standalone module (not
 ...
 */
const SEALED_PROBE_SENSITIVITIES = ['public', 'internal', 'confidential', 'sealed'];

const SEALED_PROBE_SENSITIVITY_RUN_BITS = {
  public: null,
  internal: 64,
  confidential: 8,
  sealed: 0,
...
module.exports = { SEALED_PROBE_SENSITIVITIES, SEALED_PROBE_SENSITIVITY_RUN_BITS };
