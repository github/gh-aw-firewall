    ...
    apiProxy: {
      ...
      properties: {
        ...
        maxEffectiveTokens: {
          ...
          minimum: 1,
          description:
            'Maximum cumulative effective tokens allowed for a run. ' +
            'When reached, the API proxy rejects additional requests.',
        },
        modelMultipliers: {
          type: 'object',
          description:
            'Per-model multipliers used for effective token accounting. ' +
            'Keys are model names and values are positive multipliers.',
