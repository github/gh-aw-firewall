...
const ENCLAVE_MCP_TRANSPORT_GRACE_SECONDS = 60;
const ENCLAVE_MCP_OPERATION_TIMEOUT_SECONDS =
  Math.max(...TIMING_BUCKETS_MS) / 1_000 + ENCLAVE_MCP_TRANSPORT_GRACE_SECONDS;
