 ...
 *
 * The schema is imported via require() so that esbuild inlines it in the
 * bundle and pkg includes it in the binary snapshot automatically.
...
const schema = require('./awf-config-schema.json') as Record<string, unknown>;
