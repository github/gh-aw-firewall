 ...
 *
 * The schema JSON is imported directly so it bundles correctly with esbuild
 * (no runtime fs reads). The canonical source is generated by
 * `scripts/generate-schema.mjs` and kept in sync via CI.
 */
